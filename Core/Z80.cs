namespace Core
{
    ...
    public class Z80
    {
        ...
        public virtual void pokeb(int addr, int newByte)
        {
            mem[addr] = newByte;
        }
        ...
        private static int inc16(int a) { return (a + 1) & 0xffff; }
        private static int qinc8(int a) { return (a + 1) & 0xff; }

        /** Quick Decrement : no flags */
        private static int dec16(int a) { return (a - 1) & 0xffff; }
        private static int qdec8(int a) { return (a - 1) & 0xff; }

        /** Bit toggling */
        private static int res(int bit, int val) { return val & ~bit; }
        private static int set(int bit, int val) { return val | bit; }
    }
}