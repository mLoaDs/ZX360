...
namespace ZX360
{
    ...
    public class Main : Microsoft.Xna.Framework.Game
    {
        ...
        protected string LoadRomName(string savePath)
        {
            ...
            {
                string[] roms = Directory.GetFiles(StorageContainer.TitleLocation, "*.sna");
                if (roms.Length == 0)
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            if (running)
            {
                ...
                spriteBatch.Draw(targetTexture, new Rectangle(75, 25,
                    graphics.PreferredBackBufferWidth-150, graphics.PreferredBackBufferHeight-50), Color.White);
                spriteBatch.End();
            }
